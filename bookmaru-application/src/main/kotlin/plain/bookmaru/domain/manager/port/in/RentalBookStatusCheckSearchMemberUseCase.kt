...
interface RentalBookStatusCheckSearchMemberUseCase {
    suspend fun searchMemberExecute(command: RentalBookStatusCheckCommand) : PageResult<RentalBookStatusCheckResult>?
}