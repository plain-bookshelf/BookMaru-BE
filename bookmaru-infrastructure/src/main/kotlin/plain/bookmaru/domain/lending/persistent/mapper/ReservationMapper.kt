...
class ReservationMapper(
    ...
    fun toEntity(domain: Reservation, affiliationProxy: AffiliationEntity): BookReservationEntity {
        ...
        return BookReservationEntity(
            ...
            memberEntity = memberMapper.toEntity(domain.member, affiliationProxy)
        )
    }
}